...
<header>
        ...
        <div class="right main-header">
            ...
            <a href="profile.php" title="Profile"><i class="fa-solid fa-user select-page"></i></a>
    ...
    <section>
        ...
        <aside class="footer">
            ...
            <aside class="aside">
                <div class="biodata">
                    <div class="HeaderBio">
                        <img src="img/ikbal.jpg" alt="">
                        <h3>Ahmad Ikbal Djaya</h3><hr>
                    </div>
                    <table class="bio" cellspacing=8>
                        <tr>
                            <td>Nama</td>
                            <td>:</td>
